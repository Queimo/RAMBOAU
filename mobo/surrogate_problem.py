from problems import Problem, RiskyProblem
...
class SurrogateProblem(Problem):
    ...
    def _evaluate(self, x, out, *args, calc_gradient=False, calc_hessian=False, **kwargs):
        ...
        out['G'], out['CV'], out['feasible'] = self.real_problem.evaluate(x_ori, return_values_of=['G', 'CV', 'feasible'])


class RiskySurrogateProblem(RiskyProblem):
