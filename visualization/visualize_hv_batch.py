...
def main():
    ...
    parser.add_argument(
        "--problem", type=str, nargs="+", default=None, help="problems to test"
    )
    parser.add_argument(
        "--algo", type=str, nargs="+", default=None, help="algorithms to test"
    )
    parser.add_argument(
        "--n-seed", type=int, default=3, help="number of different seeds"
    )
    parser.add_argument(
    ...
    if args.problem is None:
        args.problem = get_problem_names()
